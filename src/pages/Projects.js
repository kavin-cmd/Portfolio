...
const projects = [
    { title: 'Machine Learning-Based Anomaly Detection in IoT Networks', description: 'Developed models using Isolation Forest and Autoencoders to detect anomalies in IoT network traffic. Focused on identifying security threats and operational issues by analyzing high-dimensional data, leading to significant improvements in detection accuracy. Applied advanced feature extraction and model evaluation techniques to enhance the reliability of IoT systems.', link: 'https://github.com/kavin-cmd/Machine-Learning-Based-Anomaly-Detection-in-IoT-Networks-Using-Isolation-Forest-and-Autoencoders' },
